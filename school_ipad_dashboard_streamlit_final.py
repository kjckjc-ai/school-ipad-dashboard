...
def load_school_data():
    try:
        ...
        csv_paths = [
            "National datasheeet.csv",  # Current directory
            "/app/National datasheeet.csv",  # Streamlit Cloud app directory
            "/home/ubuntu/upload/National datasheeet.csv",  # Upload directory
